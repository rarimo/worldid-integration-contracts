...
import {SemaphoreVerifier} from "../world-id-contracts/SemaphoreVerifier.sol";
import {SemaphoreTreeDepthValidator} from "./SemaphoreTreeDepthValidator.sol";
...
///      `abstract`.
abstract contract WorldIDBridge is IWorldID, Initializable {
    ///////////////////////////////////////////////////////////////////////////////
    ///                              CONTRACT DATA                              ///
    ///////////////////////////////////////////////////////////////////////////////
    ...
    uint256 internal ROOT_HISTORY_EXPIRY;
    ...
    function _receiveRoot(uint256 newRoot, uint256 onDemandTimestamp) internal {
        ...
        uint128 currTimestamp = uint128(onDemandTimestamp);
